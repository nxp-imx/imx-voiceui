...
extern void rdsp_plugin_set_heapmem_analysis_flag(uint32_t Amode);

extern void rdsp_plugin_malloc_init(void* Aextmem_baseptr, void* Aextmem_nextptr, size_t AextmemSize);
extern uint32_t rdsp_plugin_malloc_GetAllocatedBytes(void);
extern void* rdsp_plugin_malloc(size_t Asize, MemAlign_t align);
...
extern uint32_t rdsp_plugin_scratch_GetAllocatedBytes(void);
...
extern void rdsp_plugin_memset_32b(void* Aptr, uint32_t Aval, size_t Asize);
extern void rdsp_plugin_memset_64b(void* Aptr, uint64_t Aval, size_t Asize);
extern void rdsp_plugin_memset_float(rdsp_float* Ay, rdsp_float Aval, size_t Alength);
extern void rdsp_plugin_memset_complex(rdsp_complex* Ay, rdsp_complex Aval, size_t Alength);
...
extern uint32_t rdsp_plugin_memcompare(void* Ax, void* Ay, size_t Asize);
